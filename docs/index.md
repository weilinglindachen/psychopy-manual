...
| 階段 | 任務 | 內容 | 狀態 |
|---|---|---|---|
| 第一階段 | 任務 1–4 | 純句子判斷核心：fixation、句子呈現、`f/j` 反應、RT、Excel 條件表、自動判對錯 | ⬜ 未開始 |
| 第二階段 | 任務 5–8 | 加入音樂與正式 timing：五和弦音檔、逐字呈現、Excel 控制音檔切換 | ⬜ 未開始 |
| 第三階段 | 任務 9–11 | 擴充成完整 48 trials，並檢查四種條件是否平衡 | ⬜ 未開始 |
| 第四階段 | 任務 12–17 | 完成受試者實際看到的完整實驗（說明、練習、休息、結束畫面） | ⬜ 未開始 |
